  ...
  return (
    <div className="w-5/6 lg:w-3/6 mx-auto border shadow-lg mt-8 mb-8">
      <div className="">
       ...
       <button type="button" class="text-white bg-[#2673f0] hover:bg-[#4285F4]/90 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
